    ...
    <section class="section">
        <div class="card-header">
            ...
            <div class="card-footer text-right">
                <a class="btn btn-info" href="{{route('member.create')}}">Create Member</a>
            </div>
        </div>
            <div class="card-body">
                <div class="table-responsive">
                    <table class="table table-striped table-md v_center">
                        ...
                        <tr>
                            ...
                            <td>{{ $value->tlp }}</td>
                            <td>
                                <a href="{{ route('member.edit', $value->id) }}" title="Edit Student"><button class="btn btn-secondary btn-sm"><i class="fa fa-pencil-square-o" aria-hidden="true"></i>Edit</button></a>
                            </td>
                        </tr>
                            @empty
                            <tr>
