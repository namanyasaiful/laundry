            ...
            <div class="card-header">
                ...
                <div class="card-body">
                    <div class="form-group">
                        <label>ID</label>
                        <input type="text" name="id" class="form-control" value="{{ $outlet[0]->id }}" disabled>
                    </div>
                    <div class="form-group">
                        <label>Nama</label>
                        <input type="text" name="nama" class="form-control" value="{{ $outlet[0]->nama }}" disabled>
                    </div>
                    <div class="form-group">
                        <label>Alamat</label>
                        <input type="text" name="alamat" class="form-control" value="{{ $outlet[0]->alamat }}" disabled>
                    </div>
                    <div class="form-group">
                        <label>Telpon</label>
                        <input type="text" name="tlp" class="form-control" value="{{ $outlet[0]->tlp }}" disabled>
                    </div>
                </div>
                <div class="card-footer text-left">
                    <a class="btn btn-danger" href="{{route('outlet.index')}}">kembali</a>
                </div>
        </div>
    </section>
</div>
