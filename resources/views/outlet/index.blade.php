    ...
    <section class="section">
        <div class="card-header">
            ...
            <div class="card-footer text-right">
                <a class="btn btn-info" href="{{route('outlet.create')}}">Create Outlet</a>
            </div>
        </div>
            <div class="card-body">
                <div class="table-responsive">
                    <table class="table table-striped table-md v_center">
                        ...
                        <tr>
                            ...
                            <td>{{ $value->tlp }}</td>
                            <td>
                                <a href="{{ route('outlet.show', $value->id) }}" title="View Student"><button class="btn btn-info btn-sm"><i class="fa fa-eye" aria-hidden="true"></i> View</button></a>
                                <a href="{{ route('outlet.edit', $value->id) }}" title="Edit Student"><button class="btn btn-secondary btn-sm"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Edit</button></a>
