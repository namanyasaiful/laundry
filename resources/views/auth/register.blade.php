                ...
                <div class="row">
                    <div class="col-12 col-sm-8 offset-sm-2 col-md-6 offset-md-3 col-lg-6 offset-lg-3 col-xl-4 offset-xl-4">
                        <div class="login-brand">
                            <img src="{{ asset('http://puffintheme.com/craft/codiepie/dist/assets/img/CodiePie-fill.svg') }}" alt="logo" width="100" class="shadow-light rounded-circle">
                        </div>
                            ...
                            <div class="card-body">
                                <form  action="{{ route('auth.store') }}" method="POST">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input id="ussername" class="form-control" name="nama" tabindex="1" required autofocus>
                                    ...
                                    <div class="mt-5 text-muted text-center">
                                        have an account? <a href="{{ route('auth.login')}}">click here!</a>
                                    </div>
                                </form>
                            </div>
                        </div>
