...
<div class="main-content" style="min-height: 659px;">
    <section class="section">
        <div class="card">
            ...
            <form action="{{ route('transaksi.update', $transaksi[0]->id)}}" method="POST">
                @csrf
                @method('PUT')
                <div class="card-body">
                    <div class="form-group">
                        <label>Nama_paket</label>
                        <input type="text" name="nama" class="form-control" value="{{ $outlet[0]->nama_paket }}" disabled>
                    </div>
                    <div class="form-group">
                        <label>Member</label>
                        <input type="text" name="alamat" class="form-control" value="{{ $member[0]->nama }}" disabled>
                    </div>
                    <div class="form-group">
